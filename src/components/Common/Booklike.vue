      ...
      <li v-for="(val,index) in hotlist_1" :key="index" class="clearfix col1">
        <!-- <router-link :to="{name:'Bookinfo',params: {id: val.bookid}}" class="flex">
          ...
          <div class="book_info">
            ...
            <p class="book_type flex">{{val.typename}}</p>
        ...
        <a
          href="javascript:;"
          @click.stop="jump_bookinfo(val.bookid,val.isread,val.chapter_id)"
          class="flex"
        >
          <div class="imgBox">
            <span class="book_pop" v-if="pop !=='NO' ">{{pop}}</span>
...
.bookBox li:nth-of-type(10n + 9) .book_des,
.bookBox li:nth-of-type(10n + 10) .book_des {
  display: none;
}
.bookBox li:nth-of-type(10n + 9) .book_type,
.bookBox li:nth-of-type(10n + 10) .book_type {
  display: none;
}
.bookBox li:nth-of-type(10n + 9) .bookInfo,
.bookBox li:nth-of-type(10n + 10) .bookInfo {
  position: relative !important;
  bottom: 0 !important;
}
.bookBox li:nth-of-type(10n + 9) .bookInfo span:nth-of-type(1),
.bookBox li:nth-of-type(10n + 10) .bookInfo span:nth-of-type(1) {
  margin-right: 0.2rem !important;
}
.bookBox li:nth-of-type(10n + 9) .bookInfo span:nth-of-type(3),
.bookBox li:nth-of-type(10n + 10) .bookInfo span:nth-of-type(3) {
  display: none;
}
.bookBox li:nth-of-type(10n + 9) a .imgBox,
.bookBox li:nth-of-type(10n + 10) a .imgBox {
  width: 100%;
  margin-right: 0;
  min-height: 12rem;
  /* overflow: hidden; */
}
.bookBox li:nth-of-type(10n + 9) a .imgBox img,
...
.bookBox li:nth-of-type(10n + 9) a,
.bookBox li:nth-of-type(10n + 10) a {
  display: block !important;
  overflow: hidden;
}
.bookBox li:nth-of-type(10n + 9) {
  float: left;
  width: 48%;
}
.bookBox li:nth-of-type(10n + 10) {
  float: right !important;
  width: 48%;
}
.bookBox li:nth-of-type(10n + 6),
.bookBox li:nth-of-type(10n + 7),
.bookBox li:nth-of-type(10n + 8) {
  float: left;
  /* width: 33%; */
  width: 32%;
}
...
.bookBox li:nth-of-type(10n + 6) .book_des,
.bookBox li:nth-of-type(10n + 7) .book_des,
.bookBox li:nth-of-type(10n + 8) .book_des {
  display: none;
}
.bookBox li:nth-of-type(10n + 6) .book_type,
.bookBox li:nth-of-type(10n + 7) .book_type,
.bookBox li:nth-of-type(10n + 8) .book_type {
  display: none;
}
.bookBox li:nth-of-type(10n + 6) .bookInfo,
.bookBox li:nth-of-type(10n + 7) .bookInfo,
.bookBox li:nth-of-type(10n + 8) .bookInfo {
  position: relative !important;
  bottom: 0 !important;
}
.bookBox li:nth-of-type(10n + 6) .bookInfo span:nth-of-type(1),
.bookBox li:nth-of-type(10n + 7) .bookInfo span:nth-of-type(1),
.bookBox li:nth-of-type(10n + 8) .bookInfo span:nth-of-type(1) {
  margin-right: 0.2rem !important;
}
.bookBox li:nth-of-type(10n + 6) .bookInfo span:nth-of-type(3),
.bookBox li:nth-of-type(10n + 7) .bookInfo span:nth-of-type(3),
.bookBox li:nth-of-type(10n + 8) .bookInfo span:nth-of-type(3) {
  display: none;
}
.bookBox li:nth-of-type(10n + 6) a,
.bookBox li:nth-of-type(10n + 7) a,
.bookBox li:nth-of-type(10n + 8) a {
  display: block !important;
  overflow: hidden;
}
.bookBox li:nth-of-type(10n + 6) a .imgBox,
.bookBox li:nth-of-type(10n + 7) a .imgBox,
.bookBox li:nth-of-type(10n + 8) a .imgBox {
  width: 100%;
  margin-right: 0;
  min-height: 6rem;
  /* overflow: hidden; */
